      ...
      <div className="space-y-10 pb-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-1">
            <h1 className="text-3xl font-bold dark:text-white">Inventory Control</h1>
            <p className="text-[var(--muted)] font-medium">Monitor stock levels and manage supplier restocks.</p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-[3rem] border border-[var(--border)] shadow-sm overflow-hidden transition-colors">
          <div className="p-10 flex items-center justify-between border-b border-[var(--border)]">
            <h3 className="text-xl font-bold dark:text-white">Warehouse Status</h3>
          </div>
